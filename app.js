...
const providers=[
 ...
 {name:'Zoë J. Gonzales-Rabathaly, PA-C',role:'Physician Assistant',photo:'https://totalspineortho.com/wp-content/uploads/2025/07/zoe-768x768.webp',summary:'Spine, pain-management, and surgical PA support for new evaluations, injections, and ongoing claim coordination.',bio:{why:'Zoë Gonzales-Rabathaly is a strong resource for workers’ comp cases that need efficient evaluation, education, and care coordination across spine, orthopedic, and pain-management pathways. Her profile highlights more than 13 years of clinical experience in interventional pain management, spine care, and surgical specialties, including neurosurgery spine PA experience and pre- and post-surgical care. She also supports pain relief injections, evaluation of new patients, and treatment for neck, back, and orthopedic concerns.',best:['New spine or orthopedic evaluations','Neck and back pain claims','Pain relief injection pathway','Pre-op / post-op support','Ongoing treatment-plan coordination'],value:'Best fit when the case needs strong clinical follow-through, patient education, and coordinated support so the injured worker and case manager understand the next step.'},tags:['Spine support','Pain management','Patient coordination'],url:'https://totalspineortho.com/our-physicians/zoe-j-gonzales-rabathaly-pa-c/'}
];
